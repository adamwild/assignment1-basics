...
def run_linear(
    ...
    lin = Linear(d_in, d_out, device=None, dtype=None)
    lin.W.data = weights
...
def run_embedding(
    ...
    emb = Embedding(vocab_size, d_model, device=None, dtype=None)
    emb.embedding_matrix.data = weights
...
def get_tokenizer(
    ...
    """
    from cs336_basics.bpe_codec import Tokenizer
